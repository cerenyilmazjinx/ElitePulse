...
#[derive(Debug)]
pub struct ElitePulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ElitePulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ElitePulse processing");
    
    let mut processor = ElitePulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ElitePulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ElitePulseProcessor::new(false);
